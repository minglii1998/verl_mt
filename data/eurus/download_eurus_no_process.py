...
def main():
    ...
    for example in tqdm(code_examples):
        ...
        token_length = len(tokenized.get("input_ids", []))
    ...
    # Output files
    train_path = "data/eurus/eurus_code_no_process_train_1000.json"
    eval_path = "data/eurus/eurus_code_no_process_eval_100.json"
